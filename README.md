...
<img src="https://capsule-render.vercel.app/api?type=rect&color=gradient&customColorList=0,2,2,5,30&height=260&section=header&text=Banty%20Kumar&fontSize=75&fontColor=fff&fontAlignY=42&desc=AI%2FML%20Engineer%20%7C%20LLM%20Fine-Tuning%20%7C%20Electrical%20Engineering&descSize=16&descAlignY=62&descColor=ffffffcc" width="100%"/>
...
- 🤖 **LLM Engineering:** Fine-tuned **Qwen2.5-3B-Instruct** using QLoRA (4-bit NF4) + PEFT/LoRA — only 0.96% of parameters trained, on a single consumer GPU
- 🧠 **Deep Learning:** Fine-tuned **DistilBERT** end-to-end (Hugging Face Trainer API) for sentiment classification
- 📊 **Machine Learning:** Built an interpretable credit risk model with Scikit-learn, with a reusable preprocessing pipeline
- 🌐 **Web:** Deployed a static site on **AWS S3**; build front-ends with HTML, CSS, and Bootstrap
...
<img src="https://img.shields.io/badge/TRL%20(SFTTrainer)-FF6F00?style=for-the-badge&logo=python&logoColor=white"/>

<br/><br/>

### ⚡ Electrical Engineering & Applied Quant
...
<details open>
<summary><b>🔹 CodeForge AI — LLM Fine-Tuning (QLoRA)</b> &nbsp; <img src="https://img.shields.io/badge/status-active-brightgreen?style=flat-square"/></summary>
<br>
...
<img src="https://img.shields.io/badge/PEFT%2FLoRA-4B8BBE?style=flat-square"/>
...
- Only **0.96% of parameters trainable** (~29.9M of 3.1B) — full pipeline runs on a single consumer-grade GPU (Tesla T4)
- Built end-to-end with Hugging Face Transformers + TRL's `SFTTrainer`; published the resulting LoRA adapter to the Hugging Face Hub
- Includes a qualitative evaluation notebook comparing base vs. fine-tuned outputs on code correctness and explanation quality

<!-- Optional: add your Hugging Face model link here, e.g. -->
<!-- **Model:** 🤗 [huggingface.co/banty1288/CodeForge-AI](https://huggingface.co/banty1288) -->

</details>

<details>
<summary><b>🔹 SimpleFineTune — Sentiment Analysis with DistilBERT</b> &nbsp; <img src="https://img.shields.io/badge/status-complete-blue?style=flat-square"/></summary>
<br>
...
<details>
<summary><b>🔹 Explainable Credit Risk Assessment</b> &nbsp; <img src="https://img.shields.io/badge/status-complete-blue?style=flat-square"/></summary>
<br>
...
**Key achievements:**
- Built an end-to-end machine learning system for borrower risk prediction
...
- Focused on creating an interpretable, practical credit risk workflow
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://github-readme-stats.vercel.app/api?username=banty1288&show_icons=true&theme=tokyonight&hide_border=true&bg_color=0D1117&title_color=58A6FF&icon_color=F7931E&text_color=c9d1d9"/>
  <img src="https://github-readme-stats.vercel.app/api?username=banty1288&show_icons=true&theme=default&hide_border=true&bg_color=FFFFFF&title_color=58A6FF&icon_color=F7931E&text_color=1F2937" alt="GitHub Stats" height="175"/>
</picture>
...
<picture>
  ...
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=banty1288&layout=compact&theme=default&hide_border=true&bg_color=FFFFFF&title_color=58A6FF&text_color=1F2937" alt="Top Languages" height="175"/>
</picture>
...
<picture>
  ...
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=banty1288&theme=github&bg_color=FFFFFF&color=58A6FF&line=58A6FF&point=F7931E&hide_border=true&area=true" width="95%" alt="Activity Graph"/>
</picture>
...
<img src="https://github-profile-trophy.vercel.app/?username=banty1288&theme=algolia&no-frame=true&no-bg=true&margin-w=15&row=1&column=6" alt="GitHub Trophies"/>
...
- 🚀 Building AI/ML projects end-to-end, from data to deployment
- 🧠 Learning **Agentic AI** and LLM engineering patterns
- 📚 Exploring production **MLOps**
...
<!--
  Honesty check: only list certifications/achievements you can verify with a link or credential ID.
  Example format below — replace or remove.
-->

- 🏅 _Add verified certifications here, e.g._ `Certification Name — Issuing Body (Year)` with a link to the credential
- 🏆 _Add hackathon/competition results here once finalized, with links to the submission or leaderboard_
...
- [x] Transformer fine-tuning fundamentals (LoRA / QLoRA / PEFT)
- [x] Classical ML pipelines (Scikit-learn, interpretable models)
- [ ] Agentic AI systems & tool-use pipelines
- [ ] Production MLOps (experiment tracking, model serving, monitoring)
- [ ] Distributed / large-scale training fundamentals
...
> _Add a genuine fun fact about yourself here — something true and specific reads far better to recruiters than a generic line._
...
<!-- Contribution Snake — generated by .github/workflows/snake.yml, commits output to the "output" branch -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/banty1288/banty1288/output/github-contribution-grid-snake-dark.svg"/>
  <img src="https://raw.githubusercontent.com/banty1288/banty1288/output/github-contribution-grid-snake.svg" alt="Contribution Snake animation"/>
</picture>
