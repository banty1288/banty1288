...
<!-- Generated by .github/workflows/metrics.yml — self-hosted, avoids the shared vercel.app instance's rate-limit outages -->
<img src="https://raw.githubusercontent.com/banty1288/banty1288/main/metrics.stats.svg" alt="GitHub Stats" width="95%"/>
...
<!-- Generated by .github/workflows/metrics.yml — self-hosted, avoids the shared vercel.app instance's rate-limit outages -->
<img src="https://raw.githubusercontent.com/banty1288/banty1288/main/metrics.achievements.svg" alt="GitHub Achievements" width="95%"/>
...
> 🛰️ I like digging into space-tech datasets for fun — I've worked with solar activity data from ISRO's Aditya-L1 mission (SoLEXS/HEL1OS instruments) on a side project.
...
<!--
  ...
  This will show broken until you: 1) commit that workflow file, 2) set
  Settings > Actions > General > Workflow permissions to "Read and write",
  3) run it once manually from the Actions tab. That first run creates the
  "output" branch this image points to — nothing to fix in this markup itself.
-->
<picture>
